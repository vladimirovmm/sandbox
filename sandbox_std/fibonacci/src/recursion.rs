...
//!
//! Возьмём пример из библиотеки [criterion](https://bheisler.github.io/criterion.rs/book/getting_started.html#getting_started)
...
//!
//! Попробуем оптимизировать её. Для каждого вызова функции выполняется только один рекурсивный вызов.
//!
//! ```no_run
...
//! Но все результаты близки друг к другу.

/// Реализация через рекурсию из примера библиотеки [criterion](https://bheisler.github.io/criterion.rs/book/getting_started.html#getting_started)
/// ```rust
