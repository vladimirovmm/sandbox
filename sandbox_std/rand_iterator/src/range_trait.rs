//! Цель создать трейт для Range, который добавит метод для создания итератора с рандомными числами.
...
{
    /// Метод для создания итератора с рандомными числами по этому диапазону.
    ///
    /// ```rust
    /// use rand_iterator::RandIterator;
    ///
