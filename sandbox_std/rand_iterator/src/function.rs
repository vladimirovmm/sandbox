//! Цель создать функцию возвращающую итератор с рандомными числами
//!
//! Первое, что приходит в голову, использовать уже существующий итератор и подменить в них значения
//!
//! ```no_run
...
//!
//! Но задача создать бесконечный итератор.
//!
