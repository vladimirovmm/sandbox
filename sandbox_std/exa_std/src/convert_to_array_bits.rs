//! Цель написать конвертер для преобразования числа в массив из битов
//!
//! # Реализация через форматирование
//! Самое простое в понимании через format преобразовывать значение в битовый вид
//!
//! ```rust
...
//! ```
//!
//! Чтобы заполнить старшие нули можно использовать `std::mem::size_of_val(&value) * 8`
//!
//! ```rust
