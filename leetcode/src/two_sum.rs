//! Найти индексы двух чисел в массиве, которые дают в сумме заданное число.
//! Например, если nums = [2, 7, 11, 15] и target = 9, то ответ [0, 1].
//! Нельзя использовать элементы массива дважды.
//! Предполагается что всегда есть одно решение.
//!
