//! Находит медиану двух массивов.
//!
//! Медиана двух массивов находится в середине объединенного массива.
//! Если количество элементов в массиве четное, то медиана это среднее значение двух соседних элементов.
//!
